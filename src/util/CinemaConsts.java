 ...
 * @author Roger
 */
public class CinemaConsts {

    public static final String TITLE_MAIN = "Cinema";
    
    // Menu
    public static final String TITLE_MNU_FILME = "Menu Filme";
    public static final String TITLE_MNU_SALA = "Menu Sala";
    public static final String TITLE_MNU_SESSAO = "Menu Sessão";
